...
<html lang="es">
    <head>
        ...
        <script src="../javascript/ValidacionRoles.js"></script>
        ...
        <div class="form-row">
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <div align="center">
                                    <img src="../imagenes/equipo (2).png" alt="..."/>                                    <br>
                                </div>
                                <br>
                                <form action="/Effective/RegistrarRoles" method="post" onsubmit=" return ValidacionRoles()" class="col-12">
                                    <br>
                                    <div class="form-group">
                                        <h5>Tipo usuario</h5>
                                        <input id="txt_tipo_usuario_Reg" type="text" class="form-control" name="tipo_usuario" placeholder="Ingrese el tipo de usuario"/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">
            ...
            <div class="form-group col-md-6">
                <div id="Listado" class="bd-example">
                    ...
                    <br>
                    <div class="container">
                        <form action="/Effective/consultarRoles" method="post">
                            <div class="ajuste">
                                <div id="ControlRegistro" class="input-group">
                                    <input id="txt_Id_Consultado" type="text" class=" placeholder form-control" name="IdConsultado" value="<%=buscando%>" autofocus placeholder="   Buscar por Id del rol"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body ajustar">
                                        ...
                                        <br>
                                        <%
                                            TIPO_USUARIO_DAO tipo_dao = new TIPO_USUARIO_DAO();
                                            ArrayList<TIPO_USUARIO> tipoList = new ArrayList<TIPO_USUARIO>();
                                            tipoList = tipo_dao.ConsultarListarTipo_usuario(buscando, buscando);
                                            ...
                                            for (TIPO_USUARIO U : tipoList) {

                                                out.println("<tr>");
                                                out.println("<td>" + U.getId_tipo_usuario() + "</td>");
                                                out.println("<td>" + U.getDescripcion_tipo_usuario() + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-primary form-control btn btn-login' value='Actualizar   'name='Actualizar'onclick='SetIdConsulta(" + U.getId_tipo_usuario() + ")'/>" + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-danger form-control btn btn-login ' value='' name='Eliminar' onclick='return confirmar (SetIdConsulta(" + U.getId_tipo_usuario() + "))'/>" + "</td>");
                                                out.println("</tr>");
                                                out.println("</tr>");
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <br>
                                <form action="/Effective/modificarRoles" method="post" class="col-12">
                                    <br>
                                    <div class="form-group">
                                        <h5>Id</h5>
                                        <input type="text" class="form-control" name="tipo_usuario_id" readonly="" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("Id")%>"/>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <h5>Tipo usuario</h5>
                                        <input type="text" class="form-control" name="tipo_usuario" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("descripcion")%>" required=""/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">            
