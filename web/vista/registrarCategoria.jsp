        ...
        <div class="form-row">
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <div align="center">
                                    <img src="../imagenes/orden.png" alt="..."/>                                    <br>
                                </div>
                                <br>
                                <form action="/Effective/RegistroCategoria" method="post" onsubmit=" return ValidacionCategoria()" class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="txt_nombre_categoria_Reg" type="text" class="form-control" name="nombre_categoria_producto" placeholder="Ingrese la categoria del producto"/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">
            ...
            <div class="form-group col-md-6">
                <div id="Listado" class="bd-example">
                    ...
                    <br>
                    <div class="container">
                        <form action="/Effective/consultarCategoria" method="post">
                            <div class="ajuste">
                                <div id="ControlRegistro" class="input-group">
                                    <input id="txt_Id_Consultado" type="text" class="placeholder form-control" name="IdConsultado" value="<%=buscando%>" autofocus placeholder="   Buscar por Id de la categoria"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body ajustar">
                                        ...
                                        <%
                                            ...
                                            ArrayList<CATEGORIA_PRODUCTO> categoriaList = new ArrayList<CATEGORIA_PRODUCTO>();
                                            categoriaList = categoria_dao.ConsultarListarCategoria_producto(buscando, buscando);
                                            ...
                                            for (CATEGORIA_PRODUCTO U : categoriaList) {

                                                out.println("<tr>");
                                                out.println("<td>" + U.getId_categoria_producto() + "</td>");
                                                out.println("<td>" + U.getNombre_categoria_producto() + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-primary form-control btn btn-login' value='Actualizar   'name='Actualizar'onclick='SetIdConsulta(" + U.getId_categoria_producto() + ")'/>" + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-danger form-control btn btn-login ' value='' name='Eliminar' onclick='return confirmar(SetIdConsulta(" + U.getId_categoria_producto() + "))'/>" + "</td>");
                                                out.println("</tr>");
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <br>
                                <form action="/Effective/modificarCategoria" method="post" class="col-12">
                                    <br>
                                    <div class="form-group">
                                        <h5>Id</h5>
                                        <input type="text" class="form-control" name="categoria_id" readonly="" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("Id")%>"/>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <h5>Categoria Producto</h5>
                                        <input type="text" class="form-control" name="categoria_producto" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("descripcion")%>" required=""/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">            
                                    ...
                                    <div id="ControlsitoRegistro" class="bd-example d-none">
                                        <input id="txt_Banderota_Reg" type="text" class="form-control" name="txt_Banderota_Reg"/>
                                    </div>
                                </form>
                            </div>
                        </div>
