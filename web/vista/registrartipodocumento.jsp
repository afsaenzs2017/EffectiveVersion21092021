        ...
        <div class="form-row">
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <div align="center">
                                    <img src="../imagenes/cedula-de-identidad-con-foto-de-mujer.png" alt="..."/>                                    <br>
                                </div>
                                <br>
                                <form action="/Effective/RegistrarTipodocumento" method="post" onsubmit=" return ValidacionTipodocumento()" class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="txt_tipo_doc_identificacion_usuario_Reg" type="text" class="form-control" name="tipo_doc" placeholder="Ingrese el tipo de usuario"/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">
            ...
            <div class="form-group col-md-6">
                <div id="Listado" class="bd-example">
                    ...
                    <br>
                    <div class="container">
                        <form action="/Effective/consultarDoc" method="post">
                            <div class="ajuste">
                                <div id="ControlRegistro" class="input-group">
                                    <input id="txt_Id_Consultado" type="text" class="placeholder form-control" name="IdConsultado" value="<%=buscando%>" autofocus placeholder="Buscar Id del tipo de documento"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body ajustar">
                                        ...
                                        <br>
                                        <%
                                            TIPO_DOC_IDENTIFICACION_USUARIO_DAO tipodoc_dao = new TIPO_DOC_IDENTIFICACION_USUARIO_DAO();
                                            ArrayList<TIPO_DOC_IDENTIFICACION_USUARIO> tipodocList = new ArrayList<TIPO_DOC_IDENTIFICACION_USUARIO>();
                                            tipodocList = tipodoc_dao.ConsultarListadoTipo_doc_usuario(buscando, buscando);
                                            ...
                                            for (TIPO_DOC_IDENTIFICACION_USUARIO U : tipodocList) {

                                                out.println("<tr>");
                                                out.println("<td>" + U.getId_doc_identificacion_usuario() + "</td>");
                                                out.println("<td>" + U.getTipo_doc_identificacion_usuario() + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-primary form-control btn btn-login' value='Actualizar   'name='Actualizar'onclick='SetIdConsulta(" + U.getId_doc_identificacion_usuario() + ")'/>" + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-danger form-control btn btn-login ' value='' name='Eliminar' onclick='return confirmar (SetIdConsulta(" + U.getId_doc_identificacion_usuario() + "))'/>" + "</td>");
                                                out.println("</tr>");
                                                out.println("</tr>");
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <br>
                                <form action="/Effective/modificarDoc" method="post" class="col-12">
                                    <br>
                                    <div class="form-group">
                                        <h5>Id</h5>
                                        <input type="text" class="form-control" name="tipo_doc_id" readonly="" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("Id")%>"/>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <h5>Descripcion Doc</h5>
                                        <input type="text" class="form-control" name="doc_usuario" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("descripcion")%>" required/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">            
