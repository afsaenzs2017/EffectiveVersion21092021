        ...
        <div class="form-row">
                    ...
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                <h1>Registro genero usuario</h1>
                                <div align="center">
                                    <img src="../imagenes/genero.png" alt="..."/>                                    <br>
                                </div>
                                <br>
                                <form action="/Effective/RegistrarGenerousuario" method="post" onsubmit=" return ValidacionGeneroUsuario()" class="col-12">
                                    ...
                                    <div class="form-group">
                                        <h5>Tipo usuario</h5>
                                        <input id="txt_tipo_usuario_Reg" type="text" class="form-control" name="genero_usuario" placeholder="Ingrese el tipo de usuario"/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">
            ...
            <div class="form-group col-md-6">
                <div id="Listado" class="bd-example">
                    ...
                    <br>
                    <div class="container">
                        <form action="/Effective/consultarGenero" method="post">
                            <div class="ajuste">
                                <div id="ControlRegistro" class="input-group">
                                    <input id="txt_Id_Consultado" type="text" class="placeholder form-control" name="IdConsultado" value="<%=buscando%>" autofocus placeholder="   Buscar por Id del genero"/>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body ajustar">
                                        ...
                                        <%
                                            ...
                                            ArrayList<GENERO_USUARIO> generoList = new ArrayList<GENERO_USUARIO>();
                                            generoList = genero_dao.ConsultarListarGenero_usuario(buscando, buscando);
                                            ...
                                            for (GENERO_USUARIO U : generoList) {

                                                out.println("<tr>");
                                                out.println("<td>" + U.getId_genero_usuario() + "</td>");
                                                out.println("<td>" + U.getDescripcion_genero_usuario() + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-primary form-control btn btn-login' value='Actualizar   'name='Actualizar'onclick='SetIdConsulta(" + U.getId_genero_usuario() + ")'/>" + "</td>");
                                                out.println("<td>" + "<input type = 'submit' class=' placeholder btn btn-danger form-control btn btn-login ' value='' name='Eliminar' onclick='return confirmar (SetIdConsulta(" + U.getId_genero_usuario() + "))'/>" + "</td>");
                                                out.println("</tr>");
                                                out.println("</tr>");
            ...
            <div class="form-group col-md-6">
                <div id="Actualizar" class="bd-example d-none">
                    <div class="modal-content">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                <h1>Modificar genero de usuario</h1>
                                <div align="center">
                                    <img src="../imagenes/barra-de-estado.png" alt="..."/>
                                </div>
                                <br>
                                <form action="/Effective/modificarGenero" method="post" class="col-12">
                                    <br>
                                    <div class="form-group">
                                        <h5>Id</h5>
                                        <input type="text" class="form-control" name="genero_usuario_id" readonly="" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("Id")%>"/>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <h5>Tipo usuario</h5>
                                        <input type="text" class="form-control" name="genero_usuario" placeholder="Ingrese el tipo de usuario" value="<%=request.getParameter("descripcion")%>" required/>
                                    </div>
                                    <br>
                                    <div class="row justify-content-md-center">
                                        <div class="btn-group">            
