...
public class pruebaListarINVENTARIO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("<table border=\"1\")><br><td>id_inventario</td><td>entradas</td><td>salidas</td><td>saldo</td><td>IdProducto</td><td>IdDetalleMovimiento</td>");
        ...
        for (INVENTARIO I : mi_inventario) {
            ...
            System.out.println("<td>" + I.getPRODUCTOS_id_producto() + "</td>");
            System.out.println("<td>" + I.getDETALLE_MOVIMIENTO_id_detalle_movimiento() + "</td>");
            System.out.println("</tr>");
