...
public class pruebaEliminarFORMAS_DE_PAGO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<FORMAS_DE_PAGO> mi_lista_formas_de_pago = mi_forma_de_pago_dao.ConsultarListadoFormasdePago("5", "asas");
        ...
        mi_lista_formas_de_pago = mi_forma_de_pago_dao.ConsultarListadoFormasdePago("5", "asas");
