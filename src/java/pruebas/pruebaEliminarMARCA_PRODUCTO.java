...
public class pruebaEliminarMARCA_PRODUCTO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<MARCA_PRODUCTO> mi_lista_marcaproducto = mi_marcaproducto_dao.ConsultarListadoMarcaProducto("","Lenovo");
        ...
        mi_lista_marcaproducto = mi_marcaproducto_dao.ConsultarListadoMarcaProducto("", "Lenovo");
