...
public class pruebaEliminarTIPO_USUARIO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TIPO_USUARIO> mi_lista_tipo_usuario = mi_tipo_usuario_dao.ConsultarListarTipo_usuario("", "");
        ...
        mi_lista_tipo_usuario = mi_tipo_usuario_dao.ConsultarListarTipo_usuario( "","" );
