...
public class pruebaEliminarGENERO_USUARIO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<GENERO_USUARIO> mi_lista_genero_usuario = mi_genero_usuario_dao.ConsultarListarGenero_usuario("4", "Lupe");
        ...
        mi_lista_genero_usuario = mi_genero_usuario_dao.ConsultarListarGenero_usuario("4", "Lupe");
