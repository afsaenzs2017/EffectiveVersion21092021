...
public class pruebaEliminarUNIDAD_DE_MEDIDA_PRODUCTO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<UNIDAD_DE_MEDIDA_PRODUCTO> mi_lista_unidad_de_medida_producto = mi_unidad_de_medida_dao.ConsultarListarUnidad_de_medida("", "");
        ...
        mi_lista_unidad_de_medida_producto = mi_unidad_de_medida_dao.ConsultarListarUnidad_de_medida("", "");
