...
public class pruebaEliminarESTADO_PRODUCTO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ESTADO_PRODUCTO> mi_lista_estado_producto = mi_estado_producto_dao.ConsultarListadoEstadoProducto("", "");
        ...
        mi_lista_estado_producto = mi_estado_producto_dao.ConsultarListadoEstadoProducto("", "");
