...
public class pruebaEliminarTIPO_DE_DOC_IDENTIFICACION_USUARIO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TIPO_DOC_IDENTIFICACION_USUARIO> mi_lista_doc_usuario = mi_doc_usuario_dao.ConsultarListadoTipo_doc_usuario("", "");
        ...
        mi_lista_doc_usuario = mi_doc_usuario_dao.ConsultarListadoTipo_doc_usuario("", "");
