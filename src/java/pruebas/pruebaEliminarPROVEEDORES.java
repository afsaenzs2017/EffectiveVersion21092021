...
public class pruebaEliminarPROVEEDORES {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<PROVEEDORES> mi_lista_proveedor = mi_proveedor_dao.ConsultarListadoProveedor("14547","Duracell");
        ...
        mi_lista_proveedor = mi_proveedor_dao.ConsultarListadoProveedor("14547","Duracell");
