...
public class pruebaEliminarESTADO_USUARIO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ESTADO_USUARIO> mi_lista_estado_usuario = mi_estado_usuario_dao.ConsultarListarEstado_usuario("", "");
        ...
        mi_lista_estado_usuario = mi_estado_usuario_dao.ConsultarListarEstado_usuario("", "");
