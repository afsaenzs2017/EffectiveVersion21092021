...
public class pruebaEliminarCATEGORIA_PROUCTO {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<CATEGORIA_PRODUCTO> mi_lista_Categoria_producto = Categoria_productoDAO.ConsultarListarCategoria_producto("", "");
        ...
        mi_lista_Categoria_producto = Categoria_productoDAO.ConsultarListarCategoria_producto("", "");
