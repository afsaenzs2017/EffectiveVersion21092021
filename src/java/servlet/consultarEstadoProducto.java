...
public class consultarEstadoProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        ESTADO_PRODUCTO estado_producto = null;

        estado_producto = mi_estado_producto_dao.ConsultarEstadoProducto(Identificacion);

        if (Accion != null) {

            if (estado_producto != null) {

                response.sendRedirect("/Effective/vista/registrarEstadoProducto.jsp?descripcion=" + estado_producto.getDescripcion_estado_producto()+ "&"
                        + "Id=" + estado_producto.getId_estado_producto()+ "&"
                        + "Vista=" + "Actualizar" + "&");
                System.out.println("Salio");

            } else {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('" + "No se ha podido relizar la consulta." + "\n" + "Por favor verificar el id del estado producto: " + Identificacion + "');");
                out.println("</script>");
            }
            ...
            if (estado_producto != null) {
                ...
                String respuestaRegistrada = mi_estado_producto_dao.EliminarEstado_producto(estado_producto);
