...
public class consultarEstado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ESTADO_USUARIO_DAO miestado_dao = new ESTADO_USUARIO_DAO();
        ESTADO_USUARIO estado_usuario = null;

        estado_usuario = miestado_dao.ConsultarEstado_usuario(Identificacion);

        if (Accion != null) {

            if (estado_usuario != null) {

                response.sendRedirect("/Effective/vista/registrarestadousuario.jsp?descripcion=" + estado_usuario.getDescripcion_estado_usuario()+ "&"
                        + "Id=" + estado_usuario.getId_estado_usuario()+ "&"
                        + "Vista=" + "Actualizar" + "&");
            ...
            if (estado_usuario != null) {
                ...
                String respuestaRegistrada = miestado_dao.EliminarEstado_usuario(estado_usuario);
