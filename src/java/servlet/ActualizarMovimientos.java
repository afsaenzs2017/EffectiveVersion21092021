 ...
 * @author AndresSaenz
 */
@WebServlet(name = "ActualizarMovimientos", urlPatterns = {"/ActualizarMovimientos"})
public class ActualizarMovimientos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int Clientes = Integer.parseInt(USUARIOS_id_usuario);
        ...
        mi_movimiento.setCLIENTES_idCliente(Clientes);
        
        
        System.out.println("numero_de_documento: " + numero_de_documento);
        String respuestaRegistrada = mi_movimiento_dao.ModificarMovimiento(mi_movimiento);
