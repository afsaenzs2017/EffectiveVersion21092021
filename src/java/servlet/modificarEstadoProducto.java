 ...
 * @author 57320
 */
@WebServlet(name = "modificarEstadoProducto", urlPatterns = {"/modificarEstadoProducto"})
public class modificarEstadoProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String id = request.getParameter("estado_producto_id");
        ...
        mi_estado_producto.setDescripcion_estado_producto(estado_producto);
        mi_estado_producto.setId_estado_producto(id);

        System.out.println("Identificacion: " +id );
        String respuestaRegistrada = mi_estado_producto_dao.ActualizarEstadoProducto(mi_estado_producto);
