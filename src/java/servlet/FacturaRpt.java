 ...
 * @author Luis Cubero
 */
@WebServlet(name = "FacturaRpt", urlPatterns = {"/FacturaRpt"})
public class FacturaRpt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String producto="";
        float precio=1,subtotal=1,iva=1,total=1,ssub=0,siva=0,stot=0;
        int cantidad=1;
        int codmov=1;
        try
        {
           try
           {
               ...
               Font fonttotales = new Font(Font.FontFamily.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLUE);
               ...
               PreparedStatement stmtr = cn.prepareStatement("select M.numero_de_documento,M.fecha,C.nombreCliente,C.apellidoCliente,M.id_movimiento,M.subtotal,M.total_iva,M.total_factura from movimiento M, clientes C WHERE m.CLIENTES_idCliente = c.idCliente order by id_movimiento desc limit 1");
               ...
               while(rsr.next())
                 ...
                 precio = rsr.getFloat(3);
                 subtotal = rsr.getFloat(4);
                 iva = rsr.getFloat(5);
                 total = rsr.getFloat(6);
                 ...
                 PdfPCell celdac = new PdfPCell(new Paragraph(String.valueOf(precio),fontcuerpo));
                 PdfPCell celdad = new PdfPCell(new Paragraph(String.valueOf(subtotal),fontcuerpo));
                 PdfPCell celdae = new PdfPCell(new Paragraph(String.valueOf(iva),fontcuerpo));
                 PdfPCell celdaf = new PdfPCell(new Paragraph(String.valueOf(total),fontcuerpo));
                ...
                PdfPCell celdafinala = new PdfPCell(new Paragraph(String.valueOf(ssub),fonttotales));
                PdfPCell celdafinalb = new PdfPCell(new Paragraph(String.valueOf(siva),fonttotales));
                PdfPCell celdafinalc = new PdfPCell(new Paragraph(String.valueOf(stot),fonttotales));
