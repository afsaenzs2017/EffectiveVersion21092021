...
public class TIPO_USUARIO_DAO {
    ...
    public String ModificarTipo_usuario(TIPO_USUARIO Tipo_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement(Query);
            sentencia.setString(1, Tipo_usuario.getDescripcion_tipo_usuario());
            sentencia.setString(2, Tipo_usuario.getId_tipo_usuario());
    ...
    public TIPO_USUARIO ConsultarTipo_usuario(String id_tipo_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_tipo_usuario, descripcion_tipo_usuario from TIPO_USUARIO where id_tipo_usuario = " + id_tipo_usuario);
            ResultSet rs = sentencia.executeQuery();
            while (rs.next()) {

                mitipo_usuario = new TIPO_USUARIO();
                mitipo_usuario.setId_tipo_usuario(rs.getString(1));
    ...
    public ArrayList<TIPO_USUARIO> ConsultarListarTipo_usuario(String id_tipo_usuario, String descripcion_tipo_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_tipo_usuario,descripcion_tipo_usuario"
                    + " from TIPO_USUARIO"
            ...
            while (rs.next()) {
                ...
                mi_tipo_usurio.setId_tipo_usuario(rs.getString(1));
