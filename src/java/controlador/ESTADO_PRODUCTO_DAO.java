...
public class ESTADO_PRODUCTO_DAO {
    ...
    public String ActualizarEstadoProducto(ESTADO_PRODUCTO EstadoProducto) {
        ...
        try {
            ...
            sentencia.setString(2, EstadoProducto.getId_estado_producto());
    ...
    public ESTADO_PRODUCTO ConsultarEstadoProducto(String id_estado_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_estado_producto, descripcion_estado_producto from ESTADO_PRODUCTO where id_estado_producto = " + id_estado_producto);
            ResultSet rs = sentencia.executeQuery();

            while (rs.next()) {

                miestadoproducto = new ESTADO_PRODUCTO();
                miestadoproducto.setId_estado_producto(rs.getString(1));
    ...
    public ArrayList<ESTADO_PRODUCTO> ConsultarListadoEstadoProducto(String id_estado_producto, String descripcion_estado_producto) {
        ...
        try {
            sentencia = nuevaCon.prepareStatement("select id_estado_producto, descripcion_estado_producto "
            ...
            while (rs.next()) {
                ...
                mi_estadoproducto.setId_estado_producto(rs.getString(1));
    ...
    public String EliminarEstado_producto(ESTADO_PRODUCTO Estado_producto) {
        ...
        try {
            ...
            sentencia.setString(2, Estado_producto.getId_estado_producto());
            sentencia.execute();
            miRespuesta = "";
