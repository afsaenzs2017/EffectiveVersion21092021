...
public class TIPO_DOC_IDENTIFICACION_USUARIO_DAO {
    ...
    public String ModificarTipo_de_documento_de_identificacion(TIPO_DOC_IDENTIFICACION_USUARIO Tipo_de_documento_de_identificacion) {
        ...
        try {
            ...
            sentencia.setString(2, Tipo_de_documento_de_identificacion.getId_doc_identificacion_usuario());
    ...
    public TIPO_DOC_IDENTIFICACION_USUARIO ConsultarTipo_doc_usuario(String id_doc_identificacion_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_doc_identificacion_usuario, tipo_doc_identificacion_usuario from TIPO_DOC_IDENTIFICACION_USUARIO where id_doc_identificacion_usuario = " + id_doc_identificacion_usuario);
            ResultSet rs = sentencia.executeQuery();
            while (rs.next()) {

                mi_doc_usuario = new TIPO_DOC_IDENTIFICACION_USUARIO();
                mi_doc_usuario.setId_doc_identificacion_usuario(rs.getString(1));
    ...
    public ArrayList<TIPO_DOC_IDENTIFICACION_USUARIO> ConsultarListadoTipo_doc_usuario(String id_doc_identificacion_usuario, String tipo_doc_identificacion_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_doc_identificacion_usuario,tipo_doc_identificacion_usuario"
    ...
    public String EliminarTipo_doc_usuario(TIPO_DOC_IDENTIFICACION_USUARIO Tipo_doc_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement(Query);
            sentencia.setString(1, Tipo_doc_usuario.getTipo_doc_identificacion_usuario());
            sentencia.setString(2, Tipo_doc_usuario.getId_doc_identificacion_usuario());
            sentencia.execute();
            miRespuesta = "";
