...
public class MARCA_PRODUCTO_DAO {
    ...
    public String ModificarMarcaProducto(MARCA_PRODUCTO MarcaProducto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement(Query);
            sentencia.setString(1, MarcaProducto.getNombre_marca_producto());
            sentencia.setString(2, MarcaProducto.getId_marca_producto());
    ...
    public MARCA_PRODUCTO ConsultarMarcaProducto(String id_marca_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_marca_producto, nombre_marca_producto from MARCA_PRODUCTO where id_marca_producto = " + id_marca_producto);
            ResultSet rs = sentencia.executeQuery();

            while (rs.next()) {

                mimarcaproducto = new MARCA_PRODUCTO();
                mimarcaproducto.setId_marca_producto(rs.getString(1));
    ...
    public ArrayList<MARCA_PRODUCTO> ConsultarListadoMarcaProducto(String id_marca_producto, String nombre_marca_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select  id_marca_producto, nombre_marca_producto"
                    + " from MARCA_PRODUCTO"
            ...
            while (rs.next()) {
                ...
                mi_marcaproducto.setId_marca_producto(rs.getString(1));
