...
public class UNIDAD_DE_MEDIDA_PRODUCTO_DAO {
    ...
    public String ModificarUnidad_de_medida_producto(UNIDAD_DE_MEDIDA_PRODUCTO Unidad_de_medida_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement(Query);
            sentencia.setString(1, Unidad_de_medida_producto.getDescripcion_unidad_de_medida_producto());
            sentencia.setString(2, Unidad_de_medida_producto.getId_unidad_de_medida_producto());
            sentencia.execute();
            miRespuesta = "";
    ...
    public UNIDAD_DE_MEDIDA_PRODUCTO Consultarunidad_de_medida_producto(String id_unidad_de_medida_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_unidad_de_medida_producto, descripcion_unidad_de_medida_producto from UNIDAD_DE_MEDIDA_PRODUCTO where id_unidad_de_medida_producto = " + id_unidad_de_medida_producto);
            ResultSet rs = sentencia.executeQuery();

            while (rs.next()) {

                miunidad = new UNIDAD_DE_MEDIDA_PRODUCTO();
                miunidad.setId_unidad_de_medida_producto(rs.getString(1));
    ...
    public ArrayList<UNIDAD_DE_MEDIDA_PRODUCTO> ConsultarListarUnidad_de_medida(String id_unidad_de_medida_producto, String descripcion_unidad_de_medida_producto) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_unidad_de_medida_producto,descripcion_unidad_de_medida_producto"
            ...
            while (rs.next()) {
                ...
                mi_estado_unidad_medida.setId_unidad_de_medida_producto(rs.getString(1));
