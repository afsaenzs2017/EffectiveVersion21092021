...
public class USUARIOS_DAO {
    ...
    public String AdicionarUsuarios(USUARIOS Usuarios) {
        ...
        try {
            ...
            //Encriptar la clave para actualizar
            ENCRIPDECRIP mMain = new ENCRIPDECRIP();
            String Claveaux = mMain.ecnode(secretKey, Usuarios.getClave());

            //Codificar a formato md5 la clave
            //String Claveaux=HASH.md5(Usuarios.getClave());
            //sentencia.setString(4, Usuarios.getClave());
            sentencia.setString(4, Claveaux);
    ...
    public ArrayList<USUARIOS> ConsultarListadoUsuario(String identificacion_usuario, String nombres_usuario, String apellidos_usuario) {
        ...
        try {
            ...
            sentencia = nuevaCon.prepareStatement("select id_usuario,nombres_usuario,apellidos_usuario,identificacion_usuario,clave,"
                    ...
                    + "  or (apellidos_usuario) like ('%" + apellidos_usuario + "%') ORDER BY id_usuario;");
            ResultSet rs = sentencia.executeQuery();
